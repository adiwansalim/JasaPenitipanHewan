...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Admin Penitipan | Categories Input</title>
  </head>
  <body>
    <div class="sidebar">
    ...
    <section class="home-section">
      ...
      <div class="home-content">
        ...
        <form action="categories/categories-proses.php" method="post" enctype="multipart/form-data">
            ...
            />
            <button type="submit" class="btn btnsimpan" name="simpan">
              Simpan
            </button>
          </form>
        </div>
    ...
    <script>
      ...
      sidebarBtn.onclick = function () {
        ...
        if (sidebar.classList.contains("active")) {
          sidebarBtn.classList.replace("bxmenu", "bx-menu-alt-right");
        } else sidebarBtn.classList.replace("bx-menu-alt-right", "bxmenu");
      };
    </script>
  </body>
</html>
